...
public class ContractOrderEntrustService  extends BaseService {
    ...
    public Iterable<ContractOrderEntrust> findAllOut(Predicate predicate) {
        return contractOrderEntrustRepository.findAll(predicate, new Sort(Sort.Direction.DESC, "createTime"));
    }
    ...
    public BigDecimal sumProfitAndLossBuySymbol(String baseSymbol, String coinSymbol) {
        return contractOrderEntrustRepository.sumProfitAndLossBuySymbol(baseSymbol, coinSymbol);
    }
}
