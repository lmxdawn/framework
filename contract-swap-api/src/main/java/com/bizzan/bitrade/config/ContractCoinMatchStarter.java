...
public class ContractCoinMatchStarter implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        for(ContractCoin coin : contractCoinList) {
            ...
            match.setMemberService(memberService);
            match.setMemberWalletService(memberWalletService);
            match.setRewardPromotionSettingService(rewardPromotionSettingService);
            match.setRewardRecordService(rewardRecordService);
